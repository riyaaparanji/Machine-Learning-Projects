...
class QLearningAgent:
    ...
    def discretize_state(self, state):
        ...
        # Combination of all descretized features
    ...
    def get_action(self, state, training=True):
        ...
        if training and random.random() < self.exploration_rate:
            ...
            # highest Q-value = action perfomred
    ...
    def update_exploration_rate(self):
        #to decrease epsilon over time(exploration reduces, exploitation increases)
...
def main():
    ...
    # Checking if we want to train or run
